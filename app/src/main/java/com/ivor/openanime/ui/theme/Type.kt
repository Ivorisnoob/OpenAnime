...
// Emphasizes heavier weights for headlines and larger line heights for body text.

val Typography = Typography(
    // Display - Large, expressive, high impact
    displayLarge = TextStyle(
        fontFamily = FontFamily.Default,
        fontWeight = FontWeight.Black, // Emphasized
        fontSize = 57.sp,
        lineHeight = 64.sp,
    ...
    // Label - UI elements, buttons, inputs
